<x-app-layout title="{{ isset($entreprise) ? 'Modifier' : 'Créer' }} une entreprise" is-sidebar-open="true" is-header-blur="true">
    ...
    @endif
                ...
                <div>
                  <label class="block">
                    <span>Secteur d'activité <span class="text-red-500">*</span></span>
    ...
    <option value="">-- Choisir --</option>
                ...
                <div>
                  <label class="block">
                    <span>Type d'entreprise <span class="text-red-500">*</span></span>
    ...
    @endforeach
                    ...
                    <div class="mt-2">
                        ...
                        @if($peutEtreMembre)
                            <label class="inline-flex items-center">
                                ...
                                <span class="ml-2">Je souhaite être membre CJES</span>
                            </label>
                ...
                <div>
                  <label class="block">
                    <span>Votre fonction dans l'entreprise <span class="text-red-500">*</span></span>
                  <input
                    class="form-input w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
