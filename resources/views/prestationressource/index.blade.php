<x-app-layout title="Ressources utilisées pour les prestations" is-sidebar-open="true" is-header-blur="true">
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
        ...
        <div class="mb-10">
            <div class="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-slate-800 dark:text-navy-50">Ressources utilisées pour les prestations</h1>
                    <p class="mt-2 text-slate-600 dark:text-navy-200 text-lg">Suivi des transactions pour les services et prestations</p>
                </div>
            </div>
                ...
                <div class="card bg-gradient-to-br from-blue-500 to-blue-600 text-white border-0 shadow-xl">
                    <div class="card-body p-6">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="h-12 w-12 bg-white/20 rounded-xl flex items-center justify-center">
                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                </svg>
                            </div>
                        </div>
                    </div>
        ...
        <div class="card shadow-xl">
            <div class="card-header border-b border-slate-200 dark:border-navy-500 px-6 py-4">
                <h3 class="text-xl font-semibold text-slate-800 dark:text-navy-50">Historique des transactions de prestations</h3>
            </div>
            ...
            <div class="card-body p-0">
                @if($ressources->isEmpty())
                    <div class="flex flex-col items-center justify-center py-16">
                        ...
                        <p class="text-slate-600 dark:text-navy-200 text-center max-w-md text-lg">Les transactions pour les services et prestations apparaîtront ici une fois que des prestations seront effectuées.</p>
                    </div>
                @else
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            <thead class="bg-slate-50 dark:bg-navy-800">
                                <tr>
                                    <th class="px-8 py-4 text-left text-xs font-medium text-slate-500 dark:text-navy-200 uppercase tracking-wider">Prestation</th>
