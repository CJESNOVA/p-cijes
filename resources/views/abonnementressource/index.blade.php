<x-app-layout title="Abonnements payés" is-sidebar-open="true" is-header-blur="true">
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
            ...
            <div class="flex items-center gap-4 mb-2">
                ...
                <div>
                    ...
                    <p class="mt-2 text-slate-600 dark:text-navy-200 text-lg">
                        Consultez l'historique de vos paiements d'abonnements
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-12 lg:gap-6">
            <div class="col-span-12 pt-6 lg:col-span-8 lg:pb-6">
                ...
                @if($abonnementressources->isNotEmpty())
                    <div class="card">
                        <div class="is-scrollbar-hidden min-w-full overflow-x-auto">
                            <table class="is-hoverable w-full text-left">
                                ...
                                <tbody>
                                    @foreach($abonnementressources as $abonnementressource)
                                        <tr class="border-b">
                                            <td class="px-3 py-2">
                                            ...
                                            <td class="px-3 py-2">
                                                <span class="font-medium">{{ number_format($abonnementressource->montant, 2) }}</span>
                                            ...
                                            <td class="px-3 py-2">
                                                <div class="flex justify-center space-x-2">
                                                    <a href="{{ route('abonnementressource.show', $abonnementressource->id) }}" 
                    ...
                    <div class="card">
                        <div class="card-body text-center py-12">
                            ...
                            <p class="text-slate-600 dark:text-navy-400 mb-8">
                                Vous n'avez pas encore payé d'abonnements via votre ressource KOBO.
                            </p>
