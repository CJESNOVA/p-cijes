              ...
              <div class="flex items-center justify-between mb-6">
                <h3 class="text-lg font-semibold text-slate-800">
                  ...
                  @if($diagnostic->accompagnement && $diagnostic->accompagnement->plans->count() > 0)
                    <span class="badge badge-purple badge-sm ml-2">{{ $diagnostic->accompagnement->plans->count() }}</span>
                  @endif
                </h3>
              </div>
              ...
              @if($diagnostic->accompagnement && $diagnostic->accompagnement->plans->count() > 0)
                <div class="space-y-4">
                  @foreach($diagnostic->accompagnement->plans as $plan)
                    <div class="card border-l-4 border-l-purple-500 bg-slate-50 hover:bg-slate-100 transition-colors">
                      <div class="p-4">
              ...
              <div class="max-w-xxl">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  @foreach($diagnostic->diagnosticmodulescores as $score)
                    <div class="card bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-200">
                      <div class="p-4">
