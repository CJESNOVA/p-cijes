            ...
            <form class="mt-16" action="{{ route('resetPassword') }}" method="POST">
                ...
                <div class="mt-4">
                    <label class="relative flex">
                        <input
                            class="form-input peer w-full rounded-lg bg-slate-150 px-3 py-2 pl-9 pr-20 ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring-3 dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900"
                            placeholder="Nouveau mot de passe" type="password" name="password" id="resetPassword" required />
                        <span
                        ...
                        <button type="button" id="toggleResetPassword" class="absolute right-3 top-1/2 transform -translate-y-1/2 text-slate-400 hover:text-slate-600 dark:text-navy-300 dark:hover:text-navy-100">
                            <svg id="resetEyeIcon" xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                            </svg>
                            <svg id="resetEyeOffIcon" xmlns="http://www.w3.org/2000/svg" class="size-5 hidden" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div id="resetPasswordInstructions" class="mt-2 p-3 bg-slate-50 dark:bg-navy-800 rounded-lg border border-slate-200 dark:border-navy-600 hidden">
                        ...
                        <ul class="space-y-1 text-xs text-slate-600 dark:text-navy-300">
                            <li class="flex items-center gap-2">
                                <span id="resetLengthCheck" class="text-red-500">✗</span>
                                <span>Au moins 8 caractères</span>
                            </li>
                            <li class="flex items-center gap-2">
                                <span id="resetLowercaseCheck" class="text-red-500">✗</span>
                                <span>Au moins une lettre minuscule (a-z)</span>
                            </li>
                            <li class="flex items-center gap-2">
                                <span id="resetUppercaseCheck" class="text-red-500">✗</span>
                                <span>Au moins une lettre majuscule (A-Z)</span>
                            </li>
                            <li class="flex items-center gap-2">
                                <span id="resetNumberCheck" class="text-red-500">✗</span>
                                <span>Au moins un chiffre (0-9)</span>
                            </li>
                            <li class="flex items-center gap-2">
                                <span id="resetSpecialCheck" class="text-red-500">✗</span>
                    ...
                    <div id="resetStrengthIndicator" class="mt-2 hidden">
                        <div class="flex items-center justify-between mb-1">
                            <span class="text-xs text-slate-600 dark:text-navy-300">Force du mot de passe</span>
                            <span id="resetStrengthText" class="text-xs font-medium text-slate-500 dark:text-navy-400">Faible</span>
                        </div>
                        <div class="w-full bg-slate-200 dark:bg-navy-600 rounded-full h-2">
                            <div id="resetStrengthBar" class="h-2 rounded-full transition-all duration-300 bg-red-500" style="width: 0%"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-4">
                    <label class="relative flex">
                        <input
                            class="form-input peer w-full rounded-lg bg-slate-150 px-3 py-2 pl-9 pr-20 ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring-3 dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900"
                            placeholder="Confirmer le mot de passe" type="password" name="password_confirmation" id="resetPasswordConfirmation" required />
                        <span
                            class="pointer-events-none absolute flex h-full w-10 items-center justify-center text-slate-400 peer-focus:text-primary dark:text-navy-300 dark:peer-focus:text-accent">
                            <svg xmlns="http://www.w3.org/2000/svg" class="size-5 transition-colors duration-200"
                                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <button type="button" id="toggleResetConfirmPassword" class="absolute right-3 top-1/2 transform -translate-y-1/2 text-slate-400 hover:text-slate-600 dark:text-navy-300 dark:hover:text-navy-100">
                            <svg id="resetConfirmEyeIcon" xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                            </svg>
                            <svg id="resetConfirmEyeOffIcon" xmlns="http://www.w3.org/2000/svg" class="size-5 hidden" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21" />
                            </svg>
                        </button>
                    </label>
                    ...
                    <div id="resetMatchIndicator" class="mt-2 hidden">
                        <span id="resetMatchText" class="text-xs flex items-center gap-2">
                            <span id="resetMatchIcon">✗</span>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const confirmPasswordInput = document.getElementById('resetPasswordConfirmation');
    ...
    const eyeOffIcon = document.getElementById('resetEyeOffIcon');
    const confirmEyeIcon = document.getElementById('resetConfirmEyeIcon');
    const confirmEyeOffIcon = document.getElementById('resetConfirmEyeOffIcon');
    
    // Éléments de validation
    const lengthCheck = document.getElementById('resetLengthCheck');
    const lowercaseCheck = document.getElementById('resetLowercaseCheck');
    const uppercaseCheck = document.getElementById('resetUppercaseCheck');
    const numberCheck = document.getElementById('resetNumberCheck');
    const specialCheck = document.getElementById('resetSpecialCheck');
    const strengthBar = document.getElementById('resetStrengthBar');
    const strengthText = document.getElementById('resetStrengthText');
    const matchIndicator = document.getElementById('resetMatchIndicator');
    ...
    passwordInput.addEventListener('input', function() {
        ...
        if (password.length > 0) {
            document.getElementById('resetPasswordInstructions').classList.remove('hidden');
            document.getElementById('resetStrengthIndicator').classList.remove('hidden');
        } else {
            document.getElementById('resetPasswordInstructions').classList.add('hidden');
            document.getElementById('resetStrengthIndicator').classList.add('hidden');
        }
