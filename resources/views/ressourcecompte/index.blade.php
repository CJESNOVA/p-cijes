            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="card bg-gradient-to-br from-[#152737] to-[#152737] text-white border-0 shadow-xl">
                    <div class="card-body p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-emerald-100 text-sm font-medium">Comptes ressources entreprises enregistrés</p>
                                <p class="text-3xl font-bold mt-2">
                                    {{ $types->sum(function($type) { 
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center gap-4">
                                            <div class="relative group">
                                                <div class="absolute inset-0 bg-white/30 rounded-2xl blur-xl group-hover:bg-white/40 transition-all duration-300"></div>
                                                <div class="relative h-14 w-14 bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-sm rounded-2xl flex items-center justify-center shadow-lg ring-2 ring-white/50 group-hover:scale-105 transition-all duration-300">
                                                    @if(strtoupper($type->titre) == 'BON')
                                                        <img src="{{ asset('images/ICON_BON.png') }}" alt="BON" class="w-9 h-9 object-contain drop-shadow-sm">
                                                    @elseif(strtoupper($type->titre) == 'CORIS')
                                                        <img src="{{ asset('images/ICON_CORIS.png') }}" alt="CORIS" class="w-9 h-9 object-contain drop-shadow-sm">
                                                    @elseif(strtoupper($type->titre) == 'KOBO')
                                                        <img src="{{ asset('images/ICON_KOBO.png') }}" alt="KOBO" class="w-9 h-9 object-contain drop-shadow-sm">
                                                    @elseif(strtoupper($type->titre) == 'SIKA')
                                                        <img src="{{ asset('images/ICON_SIKA.png') }}" alt="SIKA" class="w-9 h-9 object-contain drop-shadow-sm">
                                                    @else
                                            ...
                                            <div>
                                                <h3 class="text-xl font-bold text-white drop-shadow-sm">{{ $type->titre }}</h3>
                                                <p class="text-emerald-50 font-medium">
                                                    <span class="inline-flex items-center px-2 py-1 bg-white/20 rounded-full text-xs mr-2">
                                                        {{ $type->ressourcecomptes->count() }} compte(s)
                                                    </span>
                                                    <span class="inline-flex items-center px-2 py-1 bg-white/20 rounded-full text-xs">
                                                        {{ number_format($type->ressourcecomptes->sum('solde'), 0, ',', ' ') }} crédits
                                                    </span>
                                                </p>
                                            </div>
                                        </div>
                                                        ...
                                                        <div class="space-y-2">
                                                            @foreach($compte->ressourcetransactions->take(3) as $tx)
                                                                <div class="flex items-center justify-between p-3 bg-white dark:bg-navy-700 rounded-lg border border-slate-200 dark:border-navy-600">
                                                                    <div class="flex items-center gap-4">
                                                                        <div class="relative group">
                                                                            <div class="absolute inset-0 bg-gradient-to-br from-[#4FBE96]/20 to-[#4FBE96]/10 rounded-xl blur-md group-hover:from-[#4FBE96]/30 group-hover:to-[#4FBE96]/15 transition-all duration-300"></div>
                                                                            <div class="relative w-10 h-10 bg-gradient-to-br from-white to-gray-50 rounded-xl flex items-center justify-center shadow-md ring-1 ring-[#4FBE96]/20 group-hover:scale-105 group-hover:shadow-lg transition-all duration-300">
                                                                                @if($tx->formationRessource && $tx->formationRessource->ressourcetype)
                                                                                    @if(strtoupper($tx->formationRessource->ressourcetype->titre) == 'BON')
                                                                                        <img src="{{ asset('images/ICON_BON.png') }}" alt="BON" class="w-6 h-6 object-contain">
                                                                                    @elseif(strtoupper($tx->formationRessource->ressourcetype->titre) == 'CORIS')
                                                                                        <img src="{{ asset('images/ICON_CORIS.png') }}" alt="CORIS" class="w-6 h-6 object-contain">
                                                                                    @elseif(strtoupper($tx->formationRessource->ressourcetype->titre) == 'KOBO')
                                                                                        <img src="{{ asset('images/ICON_KOBO.png') }}" alt="KOBO" class="w-6 h-6 object-contain">
                                                                                    @elseif(strtoupper($tx->formationRessource->ressourcetype->titre) == 'SIKA')
                                                                                    ...
                                                                                    @endif
                                                                                @elseif($tx->prestationRessource && $tx->prestationRessource->ressourcetype)
                                                                                    @if(strtoupper($tx->prestationRessource->ressourcetype->titre) == 'BON')
                                                                                        <img src="{{ asset('images/ICON_BON.png') }}" alt="BON" class="w-6 h-6 object-contain">
                                                                                    @elseif(strtoupper($tx->prestationRessource->ressourcetype->titre) == 'CORIS')
                                                                                        <img src="{{ asset('images/ICON_CORIS.png') }}" alt="CORIS" class="w-6 h-6 object-contain">
                                                                                    @elseif(strtoupper($tx->prestationRessource->ressourcetype->titre) == 'KOBO')
                                                                                        <img src="{{ asset('images/ICON_KOBO.png') }}" alt="KOBO" class="w-6 h-6 object-contain">
                                                                                    @elseif(strtoupper($tx->prestationRessource->ressourcetype->titre) == 'SIKA')
                                                                                        <img src="{{ asset('images/ICON_SIKA.png') }}" alt="SIKA" class="w-6 h-6 object-contain">
                                                                                    @else
                                                                                        <svg class="w-5 h-5 text-[#4FBE96]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z"></path>
                                                                                    ...
                                                                                    @endif
                                                                                @elseif($tx->evenementRessource && $tx->evenementRessource->ressourcetype)
                                                                                    @if(strtoupper($tx->evenementRessource->ressourcetype->titre) == 'BON')
                                                                                        <img src="{{ asset('images/ICON_BON.png') }}" alt="BON" class="w-6 h-6 object-contain">
                                                                                    @elseif(strtoupper($tx->evenementRessource->ressourcetype->titre) == 'CORIS')
                                                                                        <img src="{{ asset('images/ICON_CORIS.png') }}" alt="CORIS" class="w-6 h-6 object-contain">
                                                                                    @elseif(strtoupper($tx->evenementRessource->ressourcetype->titre) == 'KOBO')
                                                                                        <img src="{{ asset('images/ICON_KOBO.png') }}" alt="KOBO" class="w-6 h-6 object-contain">
                                                                                    @elseif(strtoupper($tx->evenementRessource->ressourcetype->titre) == 'SIKA')
                                                                                        <img src="{{ asset('images/ICON_SIKA.png') }}" alt="SIKA" class="w-6 h-6 object-contain">
                                                                                    @else
                                                                                        <svg class="w-5 h-5 text-[#4FBE96]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z"></path>
                                                                                    ...
                                                                                    @endif
                                                                                @elseif($tx->espaceRessource && $tx->espaceRessource->ressourcetype)
                                                                                    @if(strtoupper($tx->espaceRessource->ressourcetype->titre) == 'BON')
                                                                                        <img src="{{ asset('images/ICON_BON.png') }}" alt="BON" class="w-6 h-6 object-contain">
                                                                                    @elseif(strtoupper($tx->espaceRessource->ressourcetype->titre) == 'CORIS')
                                                                                        <img src="{{ asset('images/ICON_CORIS.png') }}" alt="CORIS" class="w-6 h-6 object-contain">
                                                                                    @elseif(strtoupper($tx->espaceRessource->ressourcetype->titre) == 'KOBO')
                                                                                        <img src="{{ asset('images/ICON_KOBO.png') }}" alt="KOBO" class="w-6 h-6 object-contain">
                                                                                    @elseif(strtoupper($tx->espaceRessource->ressourcetype->titre) == 'SIKA')
                                                                                        <img src="{{ asset('images/ICON_SIKA.png') }}" alt="SIKA" class="w-6 h-6 object-contain">
                                                                                    @else
                                                                                        <svg class="w-5 h-5 text-[#4FBE96]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z"></path>
                                                                                    ...
                                                                                    @endif
                                                                                @elseif($tx->cotisationRessource && $tx->cotisationRessource->ressourcetype)
                                                                                    @if(strtoupper($tx->cotisationRessource->ressourcetype->titre) == 'BON')
                                                                                        <img src="{{ asset('images/ICON_BON.png') }}" alt="BON" class="w-6 h-6 object-contain">
                                                                                    @elseif(strtoupper($tx->cotisationRessource->ressourcetype->titre) == 'CORIS')
                                                                                        <img src="{{ asset('images/ICON_CORIS.png') }}" alt="CORIS" class="w-6 h-6 object-contain">
                                                                                    @elseif(strtoupper($tx->cotisationRessource->ressourcetype->titre) == 'KOBO')
                                                                                        <img src="{{ asset('images/ICON_KOBO.png') }}" alt="KOBO" class="w-6 h-6 object-contain">
                                                                                    @elseif(strtoupper($tx->cotisationRessource->ressourcetype->titre) == 'SIKA')
                                                                                        <img src="{{ asset('images/ICON_SIKA.png') }}" alt="SIKA" class="w-6 h-6 object-contain">
                                                                                    @else
                                                                                        <svg class="w-5 h-5 text-[#4FBE96]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z"></path>
