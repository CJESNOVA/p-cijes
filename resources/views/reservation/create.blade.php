    ...
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
        ...
        <div class="mb-10">
            <div class="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-slate-800 dark:text-navy-50">Réservation de l'espace</h1>
                    <p class="mt-2 text-slate-600 dark:text-navy-200 text-lg">{{ $espace->titre }}</p>
                </div>
            </div>
        </div>
