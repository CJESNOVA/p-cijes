...
<head>
    ...
    <title>Bienvenue sur CJES Africa !</title>
    <style>
        ...
        /* Définition de l'effet de pulsation */
@keyframes pulsate {
    0% { 
        transform: scale(1); 
    ...
    50% { 
        ...
        box-shadow: 0 6px 15px rgba(132, 226, 175, 0.5); 
    }
    100% { 
        transform: scale(1); 
        box-shadow: 0 4px 10px rgba(132, 226, 175, 0.3); 
...
.cta-button {
    ...
    /* C'EST ICI QUE L'ANIMATION EST ACTIVÉE */
    animation: pulsate 2s infinite ease-in-out;
    
    /* Sécurité pour les vieux logiciels de mail qui ne lisent pas l'animation */
    box-shadow: 0 4px 10px rgba(132, 226, 175, 0.3);
}
        ...
        .logo-circle {
            ...
            width: 60px;
            height: 60px;
            background-color: #84E2AF; /* Votre Vert */
            border-radius: 50%;
            color: white;
            line-height: 60px;
            font-size: 30px;
        ...
        <tr>
            <td class="content" style="padding: 30px 40px 40px 40px;">
                <h1 class="welcome-title" style="color:#84E2AF; text-align:center; font-size:24px; margin:0 0 25px 0; font-family:'Segoe UI',sans-serif;">
                    Bienvenue dans l'écosystème CJES !
                    <span style="display:inline-block; vertical-align:middle; margin-left:10px;">
                        <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12 15C13.6569 15 15 13.6569 15 12C15 10.3431 13.6569 9 12 9C10.3431 9 9 10.3431 9 12C9 13.6569 10.3469 15 12 15Z" fill="#84E2AF"/>
                ...
                <p style="text-align:center;">
                    Nous sommes ravis de vous accueillir au sein de la communauté <strong>CJES</strong>. Votre compte est maintenant activé et prêt à vous faire bénéficier de toutes nos fonctionnalités.
                </p>
                ...
                <div class="features-box" style="background-color: #fcfcfc; border: 1px solid #eeeeee; border-radius: 12px; padding: 30px; margin: 30px 0;">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 18px;">
                        <tr>
                            ...
                            <td style="vertical-align: middle; font-size: 15px; color: #333333;">
                                Un <strong>Profil</strong> personnalisé et complet
                            </td>
                        </tr>
                    </table>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 18px;">
                        <tr>
                            ...
                            <td style="vertical-align: middle; font-size: 15px; color: #333333;">
                                Un <strong>Tableau de bord</strong> intuitif
                            </td>
                        </tr>
                    </table>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 18px;">
                        <tr>
                            ...
                            <td style="vertical-align: middle; font-size: 15px; color: #333333;">
                                Gestion de vos <strong>Entreprises</strong>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%;">
                        <tr>
                            ...
                            <td style="vertical-align: middle; font-size: 15px; color: #333333;">
                                Accès au statut de <strong>Membre</strong>
                            </td>
                        </tr>
                    </table>
                </div>
