<x-app-layout title="Tableau de bord CJES" is-header-blur="true">
    ...
    <main class="main-content w-full pb-8">
            ...
            <div class="col-span-12 lg:col-span-8">
                <div class="flex items-center justify-between space-x-2">
                    <h2 class="text-base font-medium tracking-wide text-slate-800 line-clamp-1 dark:text-navy-100">
                        Statistiques d'inscription et d'adhésion
                    </h2>
                ...
                <div class="flex flex-col sm:flex-row sm:space-x-7">
                    <div class="mt-4 flex shrink-0 flex-col items-center sm:items-start">
                        ...
                        <button
                            ...
                            <span> Télécharger le rapport mensuel</span>
                        </button>
                    </div>
            ...
            <div class="col-span-12 lg:col-span-4">
                <div class="grid grid-cols-2 gap-3 sm:grid-cols-3 sm:gap-5 lg:grid-cols-2">
                    <div class="rounded-lg bg-slate-150 p-4 dark:bg-navy-700">
                        ...
                        <p class="mt-1 text-xs-plus">Inscriptions</p>
                    </div>
                    <div class="rounded-lg bg-slate-150 p-4 dark:bg-navy-700">
                        ...
                        <p class="mt-1 text-xs-plus">Pépites</p>
                    </div>
                    <div class="rounded-lg bg-slate-150 p-4 dark:bg-navy-700">
                        <div class="flex justify-between">
                            <p class="text-xl font-semibold text-slate-700 dark:text-navy-100">
                        ...
                        <p class="mt-1 text-xs-plus">Membres aspirants</p>
                    </div>
                    <div class="rounded-lg bg-slate-150 p-4 dark:bg-navy-700">
                        <div class="flex justify-between">
                            <p class="text-xl font-semibold text-slate-700 dark:text-navy-100">
                        ...
                        <p class="mt-1 text-xs-plus">Membres associés</p>
                    </div>
                    <div class="rounded-lg bg-slate-150 p-4 dark:bg-navy-700">
                        <div class="flex justify-between space-x-1">
                            <p class="text-xl font-semibold text-slate-700 dark:text-navy-100">
                        ...
                        <p class="mt-1 text-xs-plus">PME</p>
                    </div>
                    <div class="rounded-lg bg-slate-150 p-4 dark:bg-navy-700">
                        <div class="flex justify-between">
                            <p class="text-xl font-semibold text-slate-700 dark:text-navy-100">
                        ...
                        <p class="mt-1 text-xs-plus">Coopératives</p>
                    </div>
                </div>
            </div>
        ...
        <div class="mt-4 grid grid-cols-12 gap-4 bg-slate-150 py-5 dark:bg-navy-800 sm:mt-5 sm:gap-5 lg:mt-6 lg:gap-6">
            <div
                ...
                <p class="mt-3 grow">
                    Cartes de membre des dernières personnes inscrites
                </p>
            ...
            <div
                ...
                <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                    ...
                    <div class="flex justify-between space-x-2">
                        <div>
                            <p class="text-xs-plus">PME</p>
                            <p class="text-xl font-semibold text-slate-700 dark:text-navy-100">
                                2 348
                            </p>
                        </div>
                        <div>
                            <p class="text-xs-plus">Avis</p>
                            <p class="text-xl font-semibold text-slate-700 dark:text-navy-100">
                                3 000
                            </p>
                        </div>
