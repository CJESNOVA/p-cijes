<x-app-layout title="Gestion des abonnements" is-sidebar-open="true" is-header-blur="true">
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-slate-600 dark:text-navy-200 text-lg">
                            Suivez et gérez les abonnements de vos entreprises membres CJES
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="grid grid-cols-12 lg:gap-6">
            <div class="col-span-12 pt-6 lg:col-span-8 lg:pb-6">
                ...
                @if($ressourceKOBO)
                    <div class="card shadow-xl border-0 bg-gradient-to-br from-blue-500 to-blue-600 mb-6">
                        <div class="card-body p-6 text-white">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <p class="text-blue-100 text-sm font-medium">Votre solde KOBO</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        <div class="card shadow-xl border-0 bg-gradient-to-br from-blue-500 to-blue-600">
                            <div class="card-body p-6 text-white">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <p class="text-[#152737]/80 text-sm font-medium">Total abonnements</p>
                                        <p class="text-3xl font-bold mt-1">
                                            {{ $entreprises->sum(function($e) { return $e->abonnements->count(); }) }}
                                        </p>
                                    </div>
                            ...
                            <div class="card-body p-6 text-white">
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p class="text-3xl font-bold mt-1">
                                            {{ number_format($entreprises->sum(function($e) { return $e->abonnements->sum('montant_paye'); }), 0) }} FCFA
                                        </p>
                                    </div>
                                    <div class="h-12 w-12 rounded-xl bg-white/20 flex items-center justify-center">
                                        <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="card-body p-6 text-white">
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p class="text-3xl font-bold mt-1">
                                            {{ $entreprises->sum(function($e) { return $e->abonnements->where('statut', '!=', 'paye')->count(); }) }}
                                        </p>
                                    </div>
                                    <div class="h-12 w-12 rounded-xl bg-white/20 flex items-center justify-center">
                                        <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                @if($entreprises->isEmpty())
                    ...
                    <div class="card shadow-xl">
                        <div class="card-body p-12 text-center">
                            <div class="h-20 w-20 rounded-xl bg-gradient-to-br from-blue-100 to-blue-200 flex items-center justify-center mx-auto mb-6">
                            ...
                            <p class="text-slate-600 dark:text-navy-200 mb-6">
                                Vous n'avez aucune entreprise qui est membre CJES. Seules les entreprises membres peuvent gérer des abonnements.
                            </p>
                            <a href="{{ route('entreprise.create') }}" 
                               class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-medium rounded-lg hover:from-blue-600 hover:to-blue-700 transition-all shadow-lg">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="card shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                                <div class="card-body p-6">
                                    ...
                                    <div class="flex items-center justify-between mb-6">
                                        ...
                                        <a href="{{ route('abonnement.create', $entreprise->id) }}" 
                                    ...
                                    <!-- Abonnements -->
                                    @if($entreprise->abonnements->isNotEmpty())
                                        <div class="overflow-x-auto">
                                            <table class="w-full">
                                                ...
                                                <tbody>
                                                    @foreach($entreprise->abonnements as $abonnement)
                                                        <tr class="border-b border-slate-100 dark:border-navy-600 hover:bg-slate-50 dark:hover:bg-navy-700/50 transition-colors">
                                                            ...
                                                            <td class="py-3 px-4 font-medium text-slate-800 dark:text-navy-50">
                                                                {{ number_format($abonnement->montant, 2) }} FCFA
                                                            </td>
                                                            <td class="py-3 px-4">
                                                                <span class="text-[#4FBE96] font-medium">{{ number_format($abonnement->montant_paye, 2) }} FCFA</span>
                                                            </td>
                                                            <td class="py-3 px-4">
                                                                <span class="text-amber-600 font-medium">{{ number_format($abonnement->montant_restant, 2) }} FCFA</span>
                                                            </td>
                                                            ...
                                                            <td class="py-3 px-4">
                                                                <div class="flex justify-center space-x-2">
                                                                    @if($abonnement->statut !== 'paye')
                                                                        ...
                                                                        <form action="{{ route('abonnement.markAsPaid', $abonnement->id) }}" method="POST" class="inline">
                                                                            @csrf
                                                                            <button type="submit" 
                                                                                    ...
                                                                                    onclick="return confirm('Payer cet abonnement avec votre solde KOBO ?')">
                                                                                <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"></path>
                                                                                </svg>
                                                                                Payer
                                                                    ...
                                                                    @endif
                                                                    <form action="{{ route('abonnement.destroy', $abonnement->id) }}" method="POST" class="inline">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <button type="submit" 
                                    ...
                                    @else
                                        <!-- État vide pour les abonnements -->
                                        <div class="text-center py-8">
                                            <div class="h-16 w-16 rounded-xl bg-gradient-to-br from-blue-100 to-blue-200 flex items-center justify-center mx-auto mb-4">
                                            ...
                                            <p class="text-slate-600 dark:text-navy-200 mb-4">
                                                Cette entreprise n'a pas encore d'abonnement enregistré
                                            </p>
                                            <a href="{{ route('abonnement.create', $entreprise->id) }}" 
                                               class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-medium rounded-lg hover:from-blue-600 hover:to-blue-700 transition-all shadow-lg">
                                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
