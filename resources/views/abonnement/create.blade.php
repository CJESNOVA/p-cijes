<x-app-layout title="Ajouter un abonnement" is-sidebar-open="true" is-header-blur="true">
                ...
                <div class="alert flex rounded-lg bg-info px-6 py-4 text-white mb-6 shadow-lg">
                    ...
                    <div>
                        ...
                        <p class="text-sm opacity-90">
                            Le montant, la période et les dates sont calculés automatiquement selon le type d'abonnement sélectionné.
                        </p>
                        ...
                        <div class="card-body p-6">
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div>
                                    ...
                                    <select name="abonnementtype_id" id="abonnementtype_id" required
                        ...
                        <div class="card-body p-6">
                            <div class="mb-4">
                                ...
                                @if(!isset($ressourcecomptes) || $ressourcecomptes->count() == 0)
                                    <p class="text-sm text-amber-600 mt-2">
                                        ...
                                        Vous devez d'abord créer des comptes ressources KOBO pour pouvoir payer les abonnements.
                                    </p>
                                @endif
                            </div>
                            ...
                            <div class="rounded-lg border border-blue-200 bg-blue-50 p-4">
                                ...
                                <p class="text-sm text-blue-700">
                                    Le montant de l'abonnement sera automatiquement débité du compte ressource sélectionné.
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const abonnementSelect = document.getElementById('abonnementtype_id');
