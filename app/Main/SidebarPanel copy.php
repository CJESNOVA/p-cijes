...
/*
    public static function membres()
    {
        return [
            ...
            'items' => [
                [
                    ...
                    'diagnostic' => [
                        'title' => 'Diagnostics Membre',
                        'route_name' => 'diagnostic.form'
                    ],
                    'diagnosticentreprise' => [
                        'title' => 'Diagnostics Entreprise',
                        'route_name' => 'diagnosticentreprise.form'
                    ],
                    'accompagnement' => [
                        'title' => 'Mes accompagnements',
                        'route_name' => 'accompagnement.mes'
     ...
     public static function geographie()
    {
        return [
            'title' => 'Geographie',
            'items' => [
    ...
    public static function all(){
        return [self::dashboards(),self::apps(), self::layouts(), self::forms(), self::components(), self::elements(), self::membres()];
    }
}
